...
namespace task_4 {
    ...
    // 10^k == 1 (mod 3) -> 16 == 1 (mod 3) -> число делится на 3 если сумма его цифр в 16ричной системе делится на 3
    ...
    // 10^k == 1 (mod 3) -> 8 == 1 (mod 7) -> число делится на 7 если сумма его цифр в 8ричной системе делится на 7
