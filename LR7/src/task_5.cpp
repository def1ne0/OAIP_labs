...
namespace task_5 {
    // ставим в соответствие каждой бочке код, начиная с нуля, переводим в троичный
    // разряды и рабов начинаем считать с нуля, если
    // на i разряде стоит 0, то он не пьет с бочки
    // если 1, пьет в первый день
    // если 2, пьет во второй день
    // *после 48ч вводится состояние рабов* 0 - не умер, 1 - умер в 1 день, 2 - умер во 2
    // получившийся результат - троичный код отравленной бочки
