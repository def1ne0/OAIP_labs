...
void menu() {
    ...
    const std::vector<std::string> essence = {
            "Ввести одномерный статический массив из k чисел. Определить количество инверсий в массиве (таких пар элементов, в которых большее значение находится слева от меньшего)"
        };
